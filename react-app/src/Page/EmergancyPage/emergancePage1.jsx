        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <p className="leftFont">In general, Australian pharmacies are similar to aggregators, not only
                        selling
                ...
                <div className="divFragment">
                    ...
                    <div className="segment1">
                        ...
                        <div class="SecondRcorners"><p>Upload your prescription or get a new online prescription.</p>
                        </div>
                    </div>
                    <div className="segment3">
                        <img className="imageRight" src={image3}/>
                        <div className="thirdRcorners"><p>Shop online with local pharmacies for off-the-shelf items.</p>
                        </div>
                    </div>
